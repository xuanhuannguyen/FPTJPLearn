    ...
    <div className="space-y-6 animate-fade-in">
      <div className="relative rounded-[24px] border-2 border-border bg-white/85 px-5 py-5 shadow-card backdrop-blur-sm md:px-7">
        ...
        <div className="min-w-0">
          <p className="text-xs font-black uppercase leading-none tracking-[0.18em] text-text-secondary">JPLearn library</p>
          ...
          <p className="mt-2 max-w-2xl text-base font-bold leading-5 text-text-secondary">Khám phá và ôn tập các bộ từ vựng theo trình độ.</p>
          {searchQuery.trim() && (
        ...
        <div className="grid grid-cols-3 gap-2 text-sm lg:min-w-[252px]">
          <div className="rounded-2xl border-2 border-border bg-bg-tertiary px-3 py-2 text-center shadow-pop">
            ...
            <div className="mt-1 text-xs font-extrabold text-text-muted">Bộ từ</div>
          </div>
