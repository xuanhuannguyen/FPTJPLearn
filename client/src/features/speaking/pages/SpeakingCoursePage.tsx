              ...
              {readingLessons.map((lesson) => {
                ...
                return (
                  <Link
                    ...
                    className={`group relative flex min-h-[205px] cursor-pointer flex-col overflow-hidden rounded-[22px] border border-orange-100 bg-white p-4 shadow-[0_14px_34px_rgba(15,23,42,0.08)] transition-all hover:-translate-y-0.5 hover:border-orange-200 hover:shadow-[0_20px_44px_rgba(234,88,12,0.13)] ${
                  ...
                  >
                    ...
                    <div className="pointer-events-none absolute bottom-3 left-7 text-4xl text-rose-100">桜</div>
                    <div className="pointer-events-none absolute bottom-7 left-20 text-xl text-rose-100">花</div>
                    ...
                    <div className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-[16px] bg-orange-50 shadow-[inset_0_0_0_1px_rgba(251,146,60,0.12)]">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full border border-orange-100 bg-white text-orange-700 shadow-[0_10px_20px_rgba(234,88,12,0.12)]">
                        <Volume2 size={22} />
                      </div>
                    </div>
                    ...
                    <div className="relative mt-4 min-w-0 flex-1">
                      ...
                      <h3 className="mt-3 line-clamp-2 font-jp text-2xl font-black leading-tight text-slate-950 transition-colors group-hover:text-orange-700">
                        {lesson.title}
                      </h3>
                      ...
                      <div className="mt-4 inline-flex items-center gap-1.5 font-heading text-sm font-black uppercase tracking-wide text-orange-800">
                        <BookOpen size={18} />
                        {isLocked ? 'Cần kích hoạt gói Premium' : `${lesson.sentenceCount} câu đọc`}
                      </div>
                    </div>

                    <div className="relative mt-3 flex shrink-0 items-center justify-end">
                      {isLocked ? (
